    ...
    <div id="fullpage">
      <div class="section" id="section0">
        <div id="front-header">
                ...
                <div class="ui grid front-menu">
                  ...
                  <div class="eleven wide column">
                    ...
                    <div class="bottom-menu">
                      ...
                      <div class="dropdown">
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                          <a href="https://solar.evn.com.vn/#/calculator" target="_blank" class="menu-item font-14 text-bold text-uppercase">Tư vấn - trải nghiệm
                          </a>
                          <img src="./images/angle-down-solid.png" />
                        </div>
                        <div class="dropdown-content">
          ...
          <div class="pushable">
            <div class="ui sidebar index-sidebar vertical menu">
              ...
              <a href="https://solar.evn.com.vn/#/calculator" target="_blank" class="item font-14 text-bold text-uppercase">Tư vấn
                - trải nghiệm
              </a>
        ...
        <div class="ui container">
          <div class="content">
            ...
            <hr />
            <h1 class="text-60 text-bold text-white mt-0 mb-20 text-shadow">Giải pháp tài chính toàn diện cho Điện mặt trời mái nhà
            </h1>
              ...
              <div class="swiper-slide">
                <div class="ui grid">
                  ...
                  <div class="eleven wide computer ten wide tablet sixteen wide mobile column">
                    <img class="slide-img" src="./images/slide-1.png">
                  </div>
                </div>
              </div>
              <div class="swiper-slide">
            ...
            <div class="eleven wide computer ten wide tablet sixteen wide mobile column">
              <div class="blocks ui grid">
                ...
                <div class="block seven wide mobile seven wide table computer column ml-40">
                  <div class="text-15 text-white">
                    <div class="circle"></div>
                    Giá trị vay dự án tối đa
                  </div>
                  <div class="text-60 text-white ">85%</div>
                </div>
                <div class="block seven wide mobile seven wide table computer column mt-30">
                  <div class="text-15 text-white">
                    <div class="circle"></div>
        ...
        <div class="ui container">
          ...
          <div class="ui grid">
            ...
            <div class="ten wide computer ten wide tablet sixteen wide mobile column">
              <form id="register-form" name="registerForm" class="ui form" onsubmit="return validateForm()" method="post">
                <div id="result"></div>
                <div class="field">
                ...
                <div class="field">
                  <div class="three fields">
                    <div class="field required">
                      ...
                      <input name="card_number" placeholder="Số CMND/CCCD" type="text" onkeyup="handleChangeCard(this.value)">
                      <div class="field-error"></div>
                    </div>
                    <div class="field required">
                      <label class="computer only">Điện thoại</label>
                      <input type="text" placeholder="Điện thoại" name="phone_number" onkeyup="handleChangePhone(this.value)">
                      <div class="field-error"></div>
                    </div>
                    <div class="field required">
                ...
                <div class="field">
                  <div class="two fields">
                    <div class="field">
                      ...
                      <select id="working-place" class="ui fluid dropdown" onchange="handleChangeWorkingPlace(this.value)">
                        <option value="">Bạn đang công tác tại</option>
                    ...
                    <div class="field non-required">
                      ...
                      <input type="text" placeholder="Đơn vị công tác" name="department" onkeyup="handleChangeDepartment(this.value)">
                      <div class="field-error"></div>
                    </div>
                ...
                <div class="field non-required">
                  <div class="two fields">
                    ...
                    <div class="field">
                      ...
                      <input type="text" name="position" onkeyup="handleChangePosition(this.value)">
                      <div class="field-error"></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="two fields">
                    <div class="field non-required">
                      ...
                      <select id="contract_duration_type" class="ui fluid dropdown">
                        <option value="" class="tex">Hợp đồng lao động</option>
                    ...
                    <div class="field">
                      ...
                      <input id="in-come" type="text" name="income" onkeyup="handleChangeIncome(this.value)">
                      <div class="field-error"></div>
                    </div>
                ...
                <div class="field">
                  ...
                  <input type="text" placeholder="Địa chỉ thường trú" name="address" onkeyup="handleChangeAddress(this.value)">
                  <div class="field-error"></div>
                </div>
                <div class="field">
                  <label class="computer only">Địa chỉ lắp đặt</label>
                  <input type="text" placeholder="Địa chỉ lắp đặt" name="installation_address" onkeyup="handleChangeInstallAdd(this.value)">
                  <div class="field-error"></div>
                </div>
                ...
                <div class="inline field">
                  <div class="ui checkbox" style="display: flex">
                    ...
                    <label>Tôi đã đọc và đồng ý với các</label> <span id="myBtn" style="color: blue; padding-left: 5px; cursor: pointer">điều kiện và điều khoản</span>
                  </div>
                </div>
                <!-- <div class="field">
                  <div class="two fields">
