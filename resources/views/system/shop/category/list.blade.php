        ...
        <table class="table table-bordered">
            <tbody>
                ...
                <tr >
                    ...
                    <td>
                        <select name="" class="form-control" ng-model="filter.category_id" ng-options="item.id as item.name for item in allCategories | filter:{ name: ''}" ng-change="getCategories()">
                            <option value="">Toàn bộ danh mục</option>
                        </select>
                    </td>
                    <td></td>
                    <td>
                        <button type="button" ng-click="getCategories()" name="button" class="btn btn-primary btn-flat margin-bottom-5 btn-block">Search</button>
                ...
                <tr ng-repeat='item in categories'>
                    ...
                    <td><a href="javascript:void(0)" class="btn btn-primary btn-sm btn-flat" title="Edit this category" ng-click="showEditForm(item)">
                            <i class="fa fa-pencil"></i>
                        </a>
                        <a href="javascript:void(0)" class="btn btn-danger btn-sm btn-flat" title="Remove this category" ng-click="showDeleteForm(item)">
                           <i class="fa fa-times"></i>
                       </a>
                       <a href="javascript:void(0)" class="btn btn-success btn-sm btn-flat" title="Copy this category" ng-click="showDuplicateForm(item)">
